    $(function(){
        ...
        $('.readerTopRight span').eq(0).click(function(){
            if ($.cookie('bg')) {
                if($.cookie('bg') == 'black'){
                    setBg('');
                }else{
        ...
        $('.readerTopRight span').eq(1).click(function(){
            $SizeNow = parseFloat($('.readerCon').css('font-size'));
            $SizeNow = $SizeNow+1;
            setfontSize($SizeNow);

        });
        $('.readerTopRight span').eq(2).click(function(){
            $SizeNow = parseFloat($('.readerCon').css('font-size'));
            $SizeNow = $SizeNow-1;
            setfontSize($SizeNow);
        ...
        function setBg($v) {
            if($v == 'black') {
                $('body').css({'background-color': '#000', 'color': '#999'});
                $('.sHeader').css({'background-color': '#000', 'border-color': '#000'});
                addCookie('bg','black');
            }else{
                $('body').css({'background-color': '', 'color': ''});
                $('.sHeader').css({'background-color': '', 'border-color': ''});
                addCookie('bg','');
            }
        }
        function setfontSize($thisSize){
            $('.readerCon').css({'font-size':$thisSize+'px'});
            addCookie('fontsize',$thisSize);
        }
